...
class OCPBaseAligator(OCPBase):
    def __init__(
        ...
        # TODO handling this initialization WILSON?
        ...
        self._solver = aligator.SolverProxDDP(
            tol=self._ocp_params.termination_tolerance,
            mu_init=self._ocp_params.eps_abs,  # TODO: is this correct WILSON?
            max_iter=self._ocp_params.solver_iters,
            sa_strategy=aligator.StepAcceptanceStrategy.LINESEARCH_NONMONOTONE,
            hess_approx=aligator.HesianApprox.GAUSS_NEWTON,
        ...
        # Convert the problem into an aligator one.
        self._aligator_problem = aligator.croc.convertCrocoddylProblem(self._problem)
        self._solver.setup(self._aligator_problem)
